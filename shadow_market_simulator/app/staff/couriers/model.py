...
def generate_courier_blueprint(
    rng, *, quality_bonus: float = 0.0, experience_level: int = 0
) -> CourierBlueprint:
    trait, pace_range, precision_range, resilience_range, integrity_range = rng.choice(
        _ARCHETYPES
    )
